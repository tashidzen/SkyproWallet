...
## Участники команды
- Беспалов Евгений — реализация страниц входа, авторизации, шапки проекта, формы добавления нового расхода на странице "Мои расходы" и работы с API в части авторизации.
- Громова Наталья — инициализация проекта, реализация страницы "Мои расходы", таблицы расходов и работы с API в части транзакций.
- Никонов Антон — реализация страницы "Анализ расходов", календаря, диаграммы расходов и работы с API в части получения данных в определённом периоде.