    ...
    <Swrapper>
      ...
      <TablesContainer>
        <ExpenseTable
          ...
          loading={loading}
        />
        {/* Форма добавления расхода: всегда видна на десктопе/планшете, скрыта на мобильных */}
        {!isMobile && (
          <NewExpenseForm
...
//   // Логика отображения:
//   // 1. На мобильных устройствах — разделение на две страницы
//   if (isMobile) {
//     if (location.pathname === '/new-expense') {
//       // Страница «Новый расход» на мобильных: только форма
//       return (
//         <Swrapper>
...
//       );
//     } else {
//       // Главная страница на мобильных: только таблица расходов
//       return (
//         <Swrapper>
//           <Stitle>Мои расходы</Stitle>
//           <TablesContainer>
...
//   // 2. На десктопе/планшетах — всегда оба компонента на одной странице
//   return (
//     <Swrapper>
//       <Stitle>Мои расходы</Stitle>
//       <TablesContainer>
